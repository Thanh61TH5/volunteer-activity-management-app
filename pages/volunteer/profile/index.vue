        ...
        <div class="border border-gray-100 shadow-md rounded-lg bg-white sm:px-20 px-5 py-10 m-3">
          ...
          <div class="space-y-5">
            ...
            <div class="flex flex-wrap">
              ...
              <p class=" text-gray-600 px-1"> {{ formatDate(volunteerData.birthday) }}</p>
            </div>
            <div class="flex flex-wrap">
            ...
            <div class="space-y-5">
              ...
              <div >
                ...
                <div class=" font-600 px-1">
                  <p class="text-gray-600 flex"><p class="pr-2 ">Giờ:</p> <p class="font-medium">{{ formatTime(volunteerData.free_time_start) }}</p> <p class="mx-2">đến</p> <p class="font-medium">{{formatTime(volunteerData.free_time_end) }}</p></p>
