...
<template>
  <div class="min-h-screen mt-10 pb-10 space-y-3 sm:w-3/4 w-full mx-auto relative">
    <div class="sm:flex">
      <div class="border border-gray-100 shadow-md rounded-lg bg-white sm:px-20 p-5 m-3">
